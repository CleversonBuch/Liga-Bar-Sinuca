...
export function MobileHeader({
    ...
    return (
        <header className="md:hidden sticky top-0 z-50 w-full bg-background/90 backdrop-blur-sm border-b border-white/5 px-4 py-3 flex items-center justify-between">
