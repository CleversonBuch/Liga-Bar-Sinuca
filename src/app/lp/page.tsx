            ...
            <section className="lp-hero">
                ...
                <div className="lp-hero__content">
                    ...
                    <div className="lp-hero__ctas">
                        <a href="#cta" className="lp-btn lp-btn--solid">Participar do Próximo Torneio</a>
                        <a href="#ranking" className="lp-btn lp-btn--outline">Ver Ranking Atual</a>
                    </div>
                </div>
            ...
            <section className="lp-section lp-section--cta" id="cta">
                <div className="lp-container">
                    <h2 className="lp-cta__headline lp-reveal">
                        Está pronto para entrar na <span className="lp-title--gold">elite</span>?
                    </h2>
                    <div className="lp-center lp-reveal">
                        <a href="/torneios" className="lp-btn lp-btn--solid lp-btn--xl">Garantir Minha Vaga</a>
                    </div>
                    <p className="lp-cta__fine lp-reveal">Vagas limitadas por torneio.</p>
                </div>
            </section>
